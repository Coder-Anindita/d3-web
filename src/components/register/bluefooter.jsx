...
import hourGlass from '../../assets/Group.svg'
  ...
  return (
    <div className="bg-[#4271FF] min-h-screen relative p-4 md:p-8 flex flex-col items-center justify-center ">
      <div className="relative ">
        ...
        <div className="relative z-10 bg-white rounded-[37.5px] border-[3px] border-black  p-7 w-full max-w-4xl flex flex-col items-center  md:space-y-6 transform -translate-x-4 -translate-y-4 md:pl-40 md:pr-40 ">
          <img
            src={curlArrow}
            alt="arrow"
          ...
          <div className="flex items-center justify-center">
            <img src={techSoc} alt="TechSociety Logo" className="w-[60px] h-[60px]" />
            <img src={tarsSoc} alt="TARS Logo" className="w-[60px] h-[60px]" />
          </div>
